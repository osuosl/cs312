# -*- coding: utf-8 -*-
#
# CS312 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'CS312.tex', u'CS312 Documentation',
...
man_pages = [
    ('index', 'cs312', u'CS312 Documentation',
...
texinfo_documents = [
  ('index', 'CS312', u'CS312 Documentation',
   u'Oregon State University', 'CS312', 'One line description of project.',
   'Miscellaneous'),
]
